...
interface PendingDueTableProps<TData, TValue> {
...
type AwesomeFilterProps = {
    ...
    credorOptions: string[];
    docRgStatus: string[];
    docCertidaoStatus: string[];
    docComprovanteResidenciaStatus: string[];
    auxFn: (e: any) => void;
};
...
export const PendingDueTable: React.FC<AwesomeFilterProps> = ({
    auxFn,
    filterColumns,
    addGlobalFilter,
    filters,
...
export function DueTable<TData, TValue>({
    columns,
    data,
    loading,
}: PendingDueTableProps<TData, TValue>) {
    ...
    function solveHeaderId(headerId: string) {
        switch (headerId) {
            ...
            case 'Doc. Comprovante de Residência Status':
                return 'Doc. Comprovante de Residência Status';
            default:
                return headerId;
        }
    }
    ...
    return (
        <div className="container pb-10 pt-4">
            <h2 className='tracking-wider font-semibold mb-8'>Pendente de enviar para Due</h2>
