...
import CVLDForm from "@/components/FormCvld";
import CVLDResult, { ApiResponse } from "@/components/ResultCVLD";
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Recalculos Feitos" total={recalculationsCount as unknown as string} rate="2.59%" levelUp>
          <svg
        ...
        <CardDataStats title="N. de Usuários" total={usersCount as unknown as string} rate="0.43%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="18"
