...
describe("Teste do Formulário Novo Precatório", () => {
  ...
  describe("Teste dos checkbox do formulário", () => {
  ...
  describe("Teste do formulário para salvar dados do oficio", () => {
    ...
    describe("Teste das labels do Formulário Dados do Processo", () => {
      ...
      it("Teste da label do formulário de Regime", async () => {
        ...
        const select =
          document.querySelector('[aria-labelledby="regime"]') ||
        ...
        expect(regime).toHaveAttribute("for", "regime");
  ...
  describe("Teste do input do Formulário Dados de Identificação", () => {
    ...
    it("Teste do Select de Espécie", async () => {
      ...
      fireEvent.change(select, {
        target: { value: "Honorários Contratuais" },
      });

      expect(select).toHaveValue("Honorários Contratuais");

      fireEvent.mouseDown(select as HTMLElement);
      fireEvent.change(select, {
        target: { value: "Honorários Sucumbenciais" },
      });

      expect(select).toHaveValue("Honorários Sucumbenciais");
    });
  ...
  describe("Teste do input do Formulário Dados do Processo", () => {
    ...
    it("Teste do input Ente Devedor", async () => {
      ...
      fireEvent.change(input, {
        target: { value: "Governo do Estado de São Paulo" },
      });
    ...
    it("Teste do input de Tribunal", async () => {
      ...
      const selectTribunal = document.querySelector('[name="tribunal"]');
