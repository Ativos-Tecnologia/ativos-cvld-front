...
describe("Testes da Página de Registro da Wallet ", () => {
  ...
  describe("Teste dos links do Formulário", () => {
    it("Teste para redirecionar para termos e condições", async () => {
      const link = screen.getAllByText(/termos e condições/i);

      expect(link[0]).toBeInTheDocument();
      await userEvent.click(link[0]);
      expect(link[0]).toHaveAttribute("href", "/termos-e-condicoes");
    });
