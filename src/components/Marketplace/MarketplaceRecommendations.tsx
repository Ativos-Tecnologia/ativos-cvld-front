...
const statsItems: Stats[] = [
  {
    image: "/images/badge-tribunal.svg",
    name: "TRF1",
    tipo: "PRECATÓRIO",
    share: 204538.58,
    returnRate: 36.8,
...
const MarketplaceRecommendations: React.FC = () => {
            ...
            >
              <div className="flex items-center justify-between ">
                <div className="flex items-center gap-2.5">
                  ...
                  <span
                        style={{ backgroundColor: iconsConfig[statsItems[index]?.tipo as keyof typeof iconsConfig].bgColor }}
                        className='flex items-center justify-center rounded-lg p-3 w-10 h-10'
                    >
                        {iconsConfig[statsItems[index]?.tipo as keyof typeof iconsConfig].icon}
                    </span>
                  </div>
