...
const BrokerQuantityDistributedChart: React.FC<IBrokerDistributionData> = ({
    ...
    return (
        <div className="col-span-6 max-h-73 rounded-sm border border-stroke bg-white py-4 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-4 xl:col-span-6">
            ...
            <div className="grid grid-cols-1">
                <div
                    className="mx-auto flex h-[200px]"
                    style={{
                        height: 220,
                        overflowY: 'visible',
                    }}
