...
const DistributionChart: React.FC<newWalletResponse> = ({ title, response: data }) => {
  ...
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white py-4 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 lg:col-span-6 xl:col-span-5">
