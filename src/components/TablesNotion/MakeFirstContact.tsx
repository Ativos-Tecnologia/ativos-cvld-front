...
import { Badge, Flowbite, Table, TableBody, TableCell, TableHead, TableHeadCell, TableRow } from 'flowbite-react';
            ...
            <Table>
                <TableHead>
                    ...
                    <TableHeadCell className="w-[0px]">
                        <div className="flex gap-2 items-center">
                            <AiOutlinePhone className='text-base' />
                            Contato Telefônico 3
                        </div>
                    </TableHeadCell>
                    <TableHeadCell className="w-[0px]">
                        <div className="flex gap-2 items-center">
                            <SiMaildotru className='text-base' />
                            Contato de E-mail
                        </div>
                    </TableHeadCell>
