    ...
    return (
        <>
            <article className='grid gap-4 py-2'>
                <h3 className='text-xl font-medium underline text-snow uppercase'>
                    1. introdução
                </h3>
                <ul className='flex flex-col gap-3 2xsm:pl-5 sm:pl-10 text-bodydark text-justify list-disc'>
                    ...
                    <li>
                        ...
                        <ul className='flex flex-col gap-3 pl-5 list-disc mt-3'>
                            <li>
                ...
                <ul className='flex flex-col gap-3 2xsm:pl-5 sm:pl-10 text-bodydark text-justify list-disc'>
                    <li>
                        ...
                        <ul className='flex flex-col gap-3 pl-5 list-disc mt-3'>
                            ...
                            <li>
                                4.1.2 - O Broker tem o direito de receber comissionamento pelas transações bem-sucedidas realizadas através da plataforma, de acordo com as condições previamente acordadas e registradas no sistema.
                            </li>
                            <li>
            ...
            <article className='grid gap-4 py-2'>
                ...
                <ul className='flex flex-col gap-3 2xsm:pl-5 sm:pl-10 text-bodydark text-justify list-disc'>
                    <li>
                        ...
                        <ul className='flex flex-col gap-3 pl-5 list-disc mt-3'>
                            <li>
                                5.1.1 - O comissionamento devido ao Broker será calculado com base nas condições previamente acordadas e registradas na plataforma no momento do cadastramento dos ativos judiciais. O valor da comissão será determinado como uma porcentagem do valor total da transação ou conforme outro critério estabelecido entre o Broker e a Ativos Precatórios.
                            </li>
                            <li>
                                5.1.2 - O Broker concorda que o comissionamento será pago somente após a conclusão bem-sucedida da transação, o que inclui a transferência efetiva dos ativos judiciais e o recebimento do pagamento pela Ativos Precatórios.
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul className='flex flex-col gap-3 pl-5 list-disc mt-3'>
                            <li>
                                5.2.1 - O pagamento do comissionamento ao Broker será efetuado em até 48 (quarenta e oito) horas após a conclusão da liquidação do ativo judicial.
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul className='flex flex-col gap-3 pl-5 list-disc mt-3'>
                            ...
                            <li>
                                5.3.4 - O Broker reconhece que o comissionamento é a única remuneração devida pela Ativos Precatórios pelas atividades de intermediação realizadas através da plataforma, não havendo qualquer outro direito a compensação ou reembolso, salvo disposição em contrário expressamente acordada entre as partes.
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul className='flex flex-col gap-3 2xsm:pl-5 sm:pl-10 text-bodydark text-justify list-disc'>
                    <li>
                        ...
                        <ul className='flex flex-col gap-3 pl-5 list-disc mt-3'>
                            ...
                            <li>
                                10.1.2 - O Broker concorda que qualquer ação ou procedimento legal decorrente ou relacionado a estes termos será iniciado nos tribunais competentes da jurisdição especificada, e o Broker consente irrevogavelmente com a jurisdição exclusiva desses tribunais.
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul className='flex flex-col gap-3 pl-5 list-disc mt-3'>
                            <li>
                                10.2.1 - Em caso de controvérsias ou disputas decorrentes destes termos, as partes concordam em tentar resolver a questão de forma amigável e de boa-fé, antes de recorrer a qualquer procedimento judicial.
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul className='flex flex-col gap-3 pl-5 list-disc mt-3'>
                            <li>
                                10.4.1 - Estes Termos e Condições de Uso constituem o acordo integral entre o Broker e a Ativos Precatórios em relação ao uso da plataforma, substituindo todos os acordos, entendimentos ou negociações anteriores, sejam orais ou escritos.
                            </li>
                        </ul>
                    </li>
                    <li>
