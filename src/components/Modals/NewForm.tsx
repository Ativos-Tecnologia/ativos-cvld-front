            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              >
                {loading ? (
                  ...
                  <>
                    {showResults ? (
                      <div className={`flex flex-col relative ${form.watch("data_requisicao")! <= "2023-04-02" && form.watch("esfera") === "FEDERAL" && form.watch('tipo_do_oficio') !== 'CREDITÓRIO' ? "pointer-events-none" : ""}`}>
                        {form.watch("data_requisicao")! <= "2023-04-02" && (form.watch("esfera") === "FEDERAL" && form.watch('tipo_do_oficio') !== 'CREDITÓRIO') && (
                        ...
                        {form.watch("data_requisicao")! <= "2023-04-02" && ((form.watch("esfera") === "ESTADUAL" || form.watch("esfera") === "MUNICIPAL") && form.watch("tipo_do_oficio") !== "CREDITÓRIO") && (
                          <div className="absolute w-full min-h-full bg-slate-700/90 flex justify-center items-center flex-col">
                            <h2 className="p-4 uppercase text-md font-medium font-satoshi w-full text-center">
                        ...
                        <div className="flex flex-col">
                          ...
                          {errorMessage && <p className="w-full text-center text-red font-medium text-xs">Valor&#40;res&#41; fora do escopo definido</p>}

                          {backendResponse.id && (
                            <Button
                              disabled={isProposalButtonDisabled}
                              onClick={saveProposalAndComission}
                              className="mx-auto mt-4 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-medium"
                            >
