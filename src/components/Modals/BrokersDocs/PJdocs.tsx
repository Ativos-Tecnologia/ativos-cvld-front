...
const PJdocs = ({
    ...
    const [representanteState, setRepresentanteState] = useState<{
    ...
    const handleRemoveDocument = async (documentType: string, from?: string) => {
        ...
        try {
            const req =
                from === 'cedente'
                    ? await api.delete(
                          `/api/cedente/unlink/doc/pj/${cedenteInfo?.id}/${documentType}/`,
                      )
                    : await api.delete(
                          `/api/cedente/unlink/doc/pf/${representanteState.data?.id}/${documentType}/`,
                      );
        ...
        if (file && cedenteInfo?.id !== null && representanteState.data?.id !== null) {
            ...
            reader.onloadend = async () => {
                ...
                if (from === 'cedente') {
                    ...
                    await setDocument(
                        representanteState.data?.id as string,
                        formData,
                        documentType,
                        from,
                    );
    ...
    return (
        <div className="overflow-y-auto overflow-x-hidden pr-3 2xsm:max-h-[85vh] xl:max-h-[480px] 3xl:max-h-[750px]">
            <h2 className="mb-10 text-center text-2xl font-medium">Gestão de documentos</h2>
            <div className="grid w-full grid-cols-2 gap-10 3xl:grid-cols-3">
                {/* ====> área do cedente <==== */}
                <fieldset className="col-span-2 grid grid-cols-2 gap-5 rounded-md p-3 lg:border lg:border-gray-200 lg:dark:border-form-strokedark 3xl:col-span-3 3xl:grid-cols-3">
                    <legend className="text-black-2 dark:text-white lg:ml-3 lg:px-2">
                                ...
                                <CardDocs.Body>
                                    <CardDocs.DocPreviewWrapper>
                                        <CardDocs.Preview
                                            onClick={() =>
                                                handleShowDoc(
                                                    cedenteInfo?.properties['Doc. Contrato Social']
                                                        .url || '',
                                                )
                                            }
                                            url={
                                        ...
                                        sub_role !== 'coordenador_externo' ? (
                                            <CelerInputField
                                                ...
                                                onValueChange={(_, value) =>
                                                    handleChangeDocStatus(cedenteInfo.id, value)
                                                }
                                            >
                                                <SelectItem
                                                    value={
                                    ...
                                    <CardDocs.Actions>
                                        ...
                                        <Button
                                            ...
                                            className="h-7 w-full bg-slate-200 px-3 text-body hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48 xl:w-full"
                                        >
                                        ...
                                        {cedenteInfo?.properties['Doc. Contrato Social'].url && (
                                            <>
                                                ...
                                                <Link
                                                    ...
                                                    className="flex h-7 w-full items-center justify-center gap-2 rounded-md bg-slate-200 px-3 text-sm text-body transition-colors duration-300 hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48 xl:w-full"
                                                >
                                                    <FaFileDownload />
                                                ...
                                                <Button
                                                    ...
                                                    className={`h-7 w-full bg-slate-200 px-3 text-sm text-body hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48 xl:w-full ${linkCopied === 'contrato_social' && '!bg-green-500 !text-snow hover:!bg-green-600'}`}
                                                >
                                                ...
                                                <Button
                                                    ...
                                                    variant="danger"
                                                    className="h-7 w-full px-3 text-sm md:max-w-44 lg:max-w-48 xl:w-full"
                                                    onClick={() =>
                ...
                <fieldset className="col-span-2 grid grid-cols-2 gap-5 rounded-md p-3 lg:border lg:border-gray-200 lg:dark:border-form-strokedark 3xl:col-span-3 3xl:grid-cols-3">
                    ...
                    {representanteState.data === null && !representanteState.isFetching && (
                        <p className="text-center text-sm">
                            Não há representante vinculado a esse cedente.
                        </p>
                    )}
                                    ...
                                    <CardDocs>
                                        ...
                                        <CardDocs.Body>
                                            <CardDocs.DocPreviewWrapper>
                                                ...
                                                {representanteState.data?.properties[
                                                    'Doc. Ofício Requisitório'
                                                ].url && sub_role !== 'coordenador_externo' ? (
                                                    <CelerInputField
                                                        fieldType={InputFieldVariant.SELECT}
                                                        name="status_doc"
                                                        className="mr-4"
                                                        disabled={
                                                            role !== 'ativos' && role !== 'juridico'
                                                        }
                                                        defaultValue={
                                                            representanteState.data?.properties[
                                                                'Doc. Ofício Requisitório Status'
                                                        ...
                                                        onValueChange={(_, value) => {
                                                            if (representanteState.data) {
                                                                handleChangeDocStatusOficioRequisitorio(
                                                                    representanteState.data.id,
                                                                    value,
                                                                );
                                                            }
                                                        }}
                                                ...
                                                {representanteState.data?.properties[
                                                    ...
                                                    <>
                                                        ...
                                                        <Link
                                                            ...
                                                            className="flex h-7 w-full items-center justify-center gap-2 rounded-md bg-slate-200 px-3 text-sm text-body transition-colors duration-300 hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48"
                                                        >
                                                            <FaFileDownload />
                                                            <span>Baixar Documento</span>
                                                        </Link>
                                                        ...
                                                        <Button
                                                            ...
                                                            className={`h-7 w-full bg-slate-200 px-3 text-sm text-body hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48 ${linkCopied === 'oficio_requisitorio' && '!bg-green-500 !text-snow hover:!bg-green-600'}`}
                                                        >
                                                            {linkCopied ===
                                                            'oficio_requisitorio' ? (
                                                                <>
                                                        ...
                                                        <Button
                                                            isLoading={
                                                                isUnlinkingDoc.oficio_requisitorio
                                                            }
                                                            variant="danger"
                                                            className="h-7 w-full px-3 text-sm md:max-w-44 lg:max-w-48"
                                                            onClick={() =>
                                                                handleRemoveDocument(
                                                                    'oficio_requisitorio',
                                                                    'representante',
                                ...
                                <CardDocs.Body>
                                    <CardDocs.DocPreviewWrapper>
                                        <CardDocs.Preview
                                            onClick={() =>
                                                handleShowDoc(
                                                    representanteState.data?.properties['Doc. RG']
                                                        .url || '',
                                                )
                                            }
                                            url={
                                    ...
                                    <CardDocs.Actions>
                                        ...
                                        <Button
                                            ...
                                            className="h-7 w-full bg-slate-200 px-3 text-body hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48"
                                        >
                                            <form onSubmit={handleSubmit(submitDocument)}>
                                                <label
                                                    htmlFor="rg"
                                        ...
                                        {representanteState.data?.properties['Doc. RG'].url && (
                                            <>
                                                ...
                                                <Button
                                                    ...
                                                    className={`h-7 w-full bg-slate-200 px-3 text-sm text-body hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48 ${linkCopied === 'rg' && '!bg-green-500 !text-snow hover:!bg-green-600'}`}
                                                >
                                                    {linkCopied === 'rg' ? (
                                                        <>
                                                            <LuClipboardCheck />
                                                ...
                                                <Button
                                                    ...
                                                    className="h-7 w-full px-3 text-sm md:max-w-44 lg:max-w-48"
                                                    onClick={() =>
                                                        handleRemoveDocument('rg', 'representante')
                                                    }
                                                >
                                                    <BiUnlink className="text-xl text-snow" />
                                                    <span>Desvincular</span>
                                        ...
                                        {representanteState.data?.properties[
                                            ...
                                            <>
                                                ...
                                                <Button
                                                    ...
                                                    className={`h-7 w-full bg-slate-200 px-3 text-sm text-body hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48 ${linkCopied === 'certidao_nasc_cas' && '!bg-green-500 !text-snow hover:!bg-green-600'}`}
                                                >
                                    ...
                                    <CardDocs.DocPreviewWrapper>
                                        ...
                                        {representanteState.data?.properties[
                                            ...
                                            <CelerInputField
                                                ...
                                                onValueChange={(_, value) => {
                                                    if (representanteState.data) {
                                                        handleChangeDocStatusComprovanteResidencia(
                                                            representanteState.data.id,
                                                            value,
                                                        );
                                                    }
                                        ...
                                        {representanteState.data?.properties[
                                            ...
                                            <>
                                                ...
                                                <Button
                                                    ...
                                                    className={`h-7 w-full bg-slate-200 px-3 text-sm text-body hover:bg-slate-300 dark:bg-slate-600 dark:text-bodydark dark:hover:bg-slate-700 md:max-w-44 lg:max-w-48 ${linkCopied === 'comprovante_de_residencia' && '!bg-green-500 !text-snow hover:!bg-green-600'}`}
                                                >
                ...
                <Button
                    ...
                    className="col-span-2 mx-auto font-medium uppercase 2xsm:w-full md:w-fit 3xl:col-span-3"
                >
                    fechar
                </Button>
            </div>

            {showDoc && <DocVisualizer isOpen={showDoc} onClose={handleCloseDoc} src={docUrl} />}
        </div>
    );
};
