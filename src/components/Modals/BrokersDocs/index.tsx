...
const DocForm = () => {
    ...
    */
    ...
    return (
      ...
      >
        <div className="relative h-fit rounded-lg border border-stroke bg-snow dark:border-strokedark dark:bg-boxdark 2xsm:w-11/12 2xsm:py-8 2xsm:px-5 md:w-4/5 md:p-10 lg:w-3/4">
